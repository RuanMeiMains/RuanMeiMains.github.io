...
| ![sparklelc](https://postimg.cc/1VrNCtKK/image.png) | TBD% | **Earthly Escapade** is Sparkle's signature light cone. While it doesn't provide any energy, which also means its crit buff passive only has about 50% uptime, the buffs it provides still prove useful. However, it is a much more viable option for Sparkle, as it is tailor-made for her.
