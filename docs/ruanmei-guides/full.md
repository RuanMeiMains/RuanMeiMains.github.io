...
??? edit "Guide Updates (Patch 2.3)"
    ...
    ### Updated Synergies
    ![gallagher](../assets/images/guides/full/gallagher.png){ align=left width=75 } Following the patch 2.1 update, Gallagher is introduced as the first sustain character with break mechanics, meant to benefit Nihility characters such as Acheron. His additional healing also scales off Break Effect. As Ruan Mei is the game's premier break support, her buffs only directly benefit Gallagher's support and utility capabilities. Read more about Ruan Mei's best and not-as-great teammates in our [Teammates Section](#teammates "Teammates Section").
