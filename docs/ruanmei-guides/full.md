...
??? edit "Guide Updates (Patch 2.3)"
    ...
    ### Updated Synergies
    ![gallagher](../assets/images/guides/full/gallagher.png){ align=left width=75 } Following the patch 2.1 update, Gallagher is introduced as the first sustain character with break mechanics, meant to benefit Nihility characters such as Acheron. His additional healing also scales off Break Effect. As Ruan Mei is the game's premier break support, her buffs only directly benefit Gallagher's support and utility capabilities. Want to learn more about Ruan Mei's best teammates? Read more about Ruan Mei's best and not-as-great teammates in our [Teammates Section](#teammates "Teammates Section").
...
??? edit "Guide Updates (Patch 2.0)"
    ...
    ![sparklelc](../assets/images/guides/full/sparklelc.png){ align=left width=75 } With the release of Sparkle, the newest and second limited Harmony character, comes a new 5-star light cone. How does this light cone compare to other existing options? Is it better than Bronya's light cone? Maybe even Meshing Cogs? Is it worth pulling if you've missed Ruan Mei's last light cone banner? Or is it just something that only Sparkle can benefit from? Find out by checking out our updated [Light Cone Recommendations](#light-cones "Light Cone Recommendations") for Ruan Mei!
